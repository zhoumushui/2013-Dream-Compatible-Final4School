...
win_frame += "	<tr>\r\n";
win_frame += "		<td width='19'><img src='" + symbol_img + "' width='19' height='21' border='0'  title='重载织梦视频' onclick='xopen_reload();'//></td>\r\n";
...
win_frame += "<img src='" + help_img + "' width='12' height='21' border='0' onclick='xopen_about()' title='关于' />";
win_frame += "<img src='" + max_img + "' id='max_button_name' onclick='maximize()' width='16' height='21' border='0' title='放大' />";
win_frame += "<img src='" + close_img + "' onclick='closeit()' width='16' height='21' border='0' title='关闭' />";
win_frame += "</td>\r\n";
win_frame += "	</tr>\r\n";
win_frame += "</table>\r\n";
win_frame += "</div>\r\n";
...
function maximize(){
	if (minrestore == 0){
		...
		max_button_name_id.setAttribute("title", '还原');
		...
		max_button_name_id.setAttribute("title", '放大');
		change_size(initialwidth, initialheight);
	}
